			...
			for (const line of realdata) {
				...
				//At the end of the match, when the winner is announced
					...
					for (let pokemonObj of Object.values(battle.p1Pokemon)) {
						if (!(Object.keys(killJsonp1).includes(pokemonObj.realName) || Object.keys(deathJsonp1).includes(pokemonObj.realName))) {
					...
					for (let pokemonObj of Object.values(battle.p2Pokemon)) {
						if (!(Object.keys(killJsonp2).includes(pokemonObj.realName) || Object.keys(deathJsonp2).includes(pokemonObj.realName))) {
